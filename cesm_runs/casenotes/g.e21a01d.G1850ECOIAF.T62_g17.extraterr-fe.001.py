...
cplhistcase = 'b.e20.B1850.f09_g17.pi_control.all.297.dayclim_0078-0098'
cplhistdir = '/glade/work/mclong/cesm_cases/hot_bats_13c/data/forcing'
...
#p = Popen('module list git',shell=True,stdout=PIPE,stderr=PIPE)
#stdout,stderr = p.communicate()
#print(stderr)
#if b'1.7.1' in stderr:
#	print('need better git version')
#    exit(1)
